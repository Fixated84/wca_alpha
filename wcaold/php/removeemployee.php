  ...
  <!--End Col-->
    ...
    <div class="row">
        <div class="col-sm-7 col-sm-offset-1 col-lg-offset-2 col-lg-6">
         <hr>
 <h3 id='typewriter'>AllStyle Homes Employee Removal </h3>
 
 <p>The email address has been removed from the data base.
 
<p>You will be redirected to <a href="employees.php">employees list</a> in <span id="counter">5</span> second(s).</p>
