...
if (isset($_GET['stocknumber'])){
	remove_vehicle($_GET['stocknumber']);
}
?>
...
<html lang="en">
  <head>
    ...
    <title>West Coast Auto - Remove Vehicle</title>
    <!-- Bootstrap -->
  ...
  <!--End Col-->
    ...
    <div class="row">
        <div class="col-sm-7 col-sm-offset-1 col-lg-offset-2 col-lg-6">
         <hr>
 <h3 id='typewriter'>West Coast Auto - Vehicle Removal </h3>
 
 <p>The email address has been removed from the data base.
 
<p>You will be redirected to <a href="vehiclelist.php">vehicle list</a> in <span id="counter">5</span> second(s).</p>
<script type="text/javascript">
function countdown() {
    var i = document.getElementById('counter');
    if (parseInt(i.innerHTML)<=0) {
        location.href = 'vehiclelist.php';
    }
