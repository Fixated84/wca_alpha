       ...
       <h3 >Welcome to West Coast Autos</h3>  <br>
         ...
         <div class="row">
           <div class="col-md-4 col-lg-offset-0 col-lg-4">
             <div class="thumbnail">
<div class="caption">
                <h3>Clients Details</h2>
                <p>This section is to add or remove clients and up date information.<br>
                </p>
                <button type="button" class="btn btn-default" onClick="window.location.href='clientlist.php'">Enter</button>
</div>
             </div>
           </div>
...
<div class="caption">
  ...
  <p>This section is to add new or remove existing employees.</p>
                  <button type="button" class="btn btn-default" onClick="window.location.href='salespersonlist.php'">Enter</button>
</div>
               </div>
             </div>
           </div>
         ...
         <br>
         <button type="button" class="btn btn-lg btn-default center-block" onClick="window.location.href='password_protect_admin.php?logout=1'" value="Log Out">Logout</button>
         <br>
         </div>
</div>
