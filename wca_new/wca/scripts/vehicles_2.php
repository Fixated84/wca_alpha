...
echo "<br><p><strong>$year $make $model $category $colour</strong></p>


<div id=\"".$stockno."\" class=\"imagemap\">
  
	<a href=\"../images/cars/".$stockno."_1.jpeg\" class=\"highslide\" onclick=\"return hs.expand(this)\">	
		
		
      <img class=\"propertys img-responsive img-cool1z\" src=\"../images/cars/".$stockno."_1.jpeg\"  alt=\"Thumbnail Image 1\"> </a>";
