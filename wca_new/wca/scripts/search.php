...
<br>
 <!--Testing Fix Nav with 3 br-->
  ...
  <fieldset class="account-info" >
    ...
    <label>
      Search
      <input  type="text"  name="search" placeholder="Search" value="<?php if (isset($_POST['search'])) echo htmlentities($_POST['search']); ?>">   <input type="submit" value="Search" name="submit" class="btn left">
    </label> 
    ...
    <input type="submit" value="Search" name="submit" class="btn left">
